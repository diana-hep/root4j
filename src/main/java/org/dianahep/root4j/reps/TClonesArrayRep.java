...
import org.dianahep.root4j.core.Clone;
import org.dianahep.root4j.core.Clones;
import org.dianahep.root4j.core.RootInput;
import org.dianahep.root4j.interfaces.TObjArray;
import org.dianahep.root4j.interfaces.TObject;
...
public abstract class TClonesArrayRep extends AbstractRootObject implements TObjArray
{
   ...
   public void readMembers(RootInput in) throws IOException
   {
      ...
      try
      {
         ...
         Class clcl = in.getFactory().getLoader().loadClass("org.dianahep.root4j.clones." + className);
         Clones clones = (Clones) clcl.newInstance();
         clones.read(in, fNobjects);

         clcl = in.getFactory().getLoader().loadClass("org.dianahep.root4j.clone." + className);
