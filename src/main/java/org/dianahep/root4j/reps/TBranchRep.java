...
import org.dianahep.root4j.core.NameMangler;
import org.dianahep.root4j.core.RootInput;
import org.dianahep.root4j.interfaces.TBasket;
 ...
 */
public abstract class TBranchRep extends AbstractRootObject implements org.dianahep.root4j.interfaces.TBranch
{
   ...
   private TBasket getBasket(int index) throws IOException
   {
      try
      {
         ...
         if (len > 0) basket.readEntryOffsets(-1);   // len is now ignored
