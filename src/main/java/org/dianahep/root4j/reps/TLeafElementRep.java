      ...
      try
      {
         ...
         if (!hollow)
         {
            ...
            if (fId < 0)
            {
               ...
               Class k = in.getFactory().getLoader().loadClass("org.dianahep.root4j.proxy2." + className);
         ...
         else
         {
            ...
            if (clonesName.length() > 0)
            {
               ...
               if (hollowClass == null)
               {
                  ...
                  String name = "org.dianahep.root4j.clones2." + branch.getClonesName();
            ...
            else
            {
               ...
               if (hollowClass == null)
               {
                  ...
                  String name = "org.dianahep.root4j.hollow." + branch.getClassName();
               ...
               //ho.setHollow((org.dianahep.root4j.interfaces.TBranch) getProxy());
   ...
   public void generateReadCode(InstructionList il, InstructionFactory factory, ConstantPoolGen cp, String className)
   {
      ...
      if (fId >= 0)
      {
         if (nBranches == 0)
         {
            ...
            //    il.append(factory.createInvoke(leafClassName,"setPosition",new ObjectType("org.dianahep.root4j.core.RootInput"), new Type[]{ Type.INT },INVOKEVIRTUAL));
