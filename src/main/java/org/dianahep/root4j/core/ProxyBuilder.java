...
class ProxyBuilder implements ClassBuilder, Constants
{
   ...
   {
      return "org.dianahep.root4j.proxy";
   }
   ...
   public JavaClass build(GenericRootClass klass)
   {
      ...
      for (ListIterator i = sup.listIterator(sup.size()); i.hasPrevious();)
      {
         ...
         String repName = "org.dianahep.root4j.reps." + rc.getClassName() + "Rep";
         try
         {
      ...
      if (cg.containsMethod("readMembers", "(Lorg/dianahep/root4j/core/RootInput;)V") == null)
      {
         MethodGen mg = new MethodGen(ACC_PUBLIC, Type.VOID, new Type[]
         {
            new ObjectType("org/dianahep/root4j/core/RootInput")
