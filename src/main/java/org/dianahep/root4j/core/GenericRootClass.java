...
{
   private final static Type rootObjectType = new ObjectType("org.dianahep.root4j.RootObject");
   ...
   {
      il.append(factory.createInvoke("org.dianahep.root4j.core.RootInput", "readObjectRef", rootObjectType, Type.NO_ARGS, INVOKEINTERFACE));
      il.append(factory.createCast(rootObjectType, getJavaType()));
   }
   ...
   {
      if (proxyClass == null)
         proxyClass = getClass(nameMangler.mangleFullClassName("org.dianahep.root4j.proxy",name));
      return proxyClass;
   }
}
