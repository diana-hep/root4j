...
public class HollowBuilder implements ClassBuilder, Constants
{
   ...
   {
      return "org.dianahep.root4j.hollow";
   }
   
   public JavaClass build(GenericRootClass klass)
   {
      String className =nameMangler.mangleFullClassName(getStem(),klass.getClassName());
      ClassGen cg = new ClassGen(className, "org/dianahep/root4j/core/Hollow", "<generated>", ACC_PUBLIC | ACC_SUPER, new String[]
      {
      ...
      try
      {
         ...
         for (Iterator i = lMap.entrySet().iterator(); i.hasNext();)
         {
            ...
            if (l == SUBOBJECT)
            {
               ...
               String name = "org.dianahep.root4j.hollow." + member.getType().getClassName();
   ...
   private void generateMethods(RootClass k, ConstantPoolGen cp, InstructionList il, InstructionFactory factory, ClassGen cg, String className)
   {
      ...
      for (int i = 0; i < members.length; i++)
      {
         ...
         if (l == SUBOBJECT)
         {
            ...
            il.append(InstructionConstants.DUP);
            il.append(factory.createCast(new ObjectType("java,lang.Object"), new ObjectType("org.dianahep.root4j.core.Hollow")));
            il.append(InstructionConstants.ALOAD_0);
            il.append(factory.createGetField("org.dianahep.root4j.core.Hollow", "index", Type.LONG));
            il.append(factory.createInvoke("org.dianahep.root4j.core.Hollow", "setHollowIndex", Type.VOID, new Type[]
            {
               Type.LONG
            }, INVOKEVIRTUAL));
         ...
         else
         {
            ...
            {
               il.append(InstructionConstants.ALOAD_0);
               il.append(factory.createGetField("org.dianahep.root4j.core.Hollow", "subIndex", Type.INT));
