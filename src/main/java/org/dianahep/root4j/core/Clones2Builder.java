 ...
 * @see org.dianahep.root4j.core.Clones2
 * @author tonyj
...
public class Clones2Builder implements ClassBuilder, Constants
{
   ...
   {
      return "org.dianahep.root4j.clones2";
   }
   ...
   public JavaClass build(GenericRootClass klass)
   {
      ...
      ClassGen cg = new ClassGen(className, "org/dianahep/root4j/core/Clones2", "<generated>", ACC_PUBLIC | ACC_SUPER, null);
...
branch: for (Iterator i = leaves.iterator(); i.hasNext();)
      ...
      {
         String cloneName = nameMangler.mangleFullClassName("org.dianahep.root4j.clone2",klass.getClassName());
         MethodGen mg = new MethodGen(ACC_PUBLIC, new ObjectType("org.dianahep.root4j.core.Clone2"), null, null, "createClone", className, il, cp);
