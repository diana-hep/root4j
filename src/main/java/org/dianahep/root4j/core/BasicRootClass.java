   ...
   protected void generateStreamer(ConstantPoolGen cp, InstructionList il, InstructionFactory factory, String className, boolean hasHeader)
   {
      if (hasHeader)
      {
         if (debugRoot)
         {
            ...
            il.append(factory.createInvoke("org.dianahep.root4j.core.RootInput", "readUnsignedShort", Type.INT, Type.NO_ARGS, INVOKEINTERFACE));
            ...
            il.append(InstructionConstants.ALOAD_1);
            il.append(factory.createInvoke("org.dianahep.root4j.core.RootInput", "getPosition", Type.LONG, Type.NO_ARGS, INVOKEINTERFACE));
         ...
         else
         {
            ...
            //il.append(factory.createInvoke("org.dianahep.root4j.core.RootInput","skipBytes",Type.INT,new Type[]{ Type.INT },INVOKEINTERFACE));
            //il.append(new POP());
         }
      }
      ...
      if (debugRoot && hasHeader)
      {
         ...
         il.append(factory.createNew("org.dianahep.root4j.core.WrongLengthException"));
         ...
         il.append(factory.createInvoke("org.dianahep.root4j.core.WrongLengthException", "<init>", Type.VOID, args, INVOKESPECIAL));
