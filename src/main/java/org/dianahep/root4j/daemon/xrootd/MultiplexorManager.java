...
import org.dianahep.root4j.daemon.xrootd.LoginOperation.LoginSession;
...
class MultiplexorManager {
    ...
    private ObjectName getObjectNameForMultiplexor(Multiplexor m) throws MalformedObjectNameException {
        return new ObjectName("org.dianahep.root4j.daemon.xrootd:type=Multiplexor,name=" + m.toString().replace(":", ";"));
    }
