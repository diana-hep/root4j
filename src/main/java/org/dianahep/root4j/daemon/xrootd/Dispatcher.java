...
import org.dianahep.root4j.daemon.xrootd.MultiplexorManager.MultiplexorReadyCallback;
...
class Dispatcher {
    ...
    private static final int WAIT_TIMEOUT = Integer.getInteger("org.dianahep.root4j.deamon.xrootd.timeout", 3000).intValue();
    private static final int WAIT_LIMIT = Integer.getInteger("org.dianahep.root4j.deamon.xrootd.waitLimit", 1000).intValue();
