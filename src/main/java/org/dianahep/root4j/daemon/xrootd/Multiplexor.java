...
class Multiplexor implements MultiplexorMBean {
    ...
    private static final int MAX_IDLE = Integer.getInteger("org.dianahep.root4j.daemon.xrootd.ConnectionTimeout", 60000);
    private static final int SEND_BUFFER_SIZE = Integer.getInteger("org.dianahep.root4j.daemon.xrootd.SendBufferSize", 65536);
    private static final int RECEIVE_BUFFER_SIZE = Integer.getInteger("org.dianahep.root4j.daemon.xrootd.ReceivedBufferSize", 65536);
