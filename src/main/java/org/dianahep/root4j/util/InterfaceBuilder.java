package org.dianahep.root4j.util;
...
{
   private File base;
   private org.dianahep.root4j.core.NameMangler nameMangler = org.dianahep.root4j.core.NameMangler.instance();
   ...
   public static void main(String[] argv) throws Exception
   {
      ...
      org.dianahep.root4j.core.RootClassFactory rcf = rfr.getFactory();
      ...
      else
      {
         ...
         for (Iterator i = list.iterator(); i.hasNext();)
         {
            ...
            try
            {
               Class k = Class.forName("org.dianahep.root4j.interfaces." + name);
   ...
   public File write(RootClass klass) throws IOException
   {
      ...
      if (!packidge.toString().equals("org.dianahep.root4j.interfaces"))
         out.println("import org.dianahep.root4j.interfaces.*;");
      out.println();
      out.print("public interface " + klassName + " extends org.dianahep.root4j.RootObject");
